...
export const adminTranslations: Translations = {
  zh: {
    ...
    'nav.database': '数据库监控',
    'nav.tasks': '任务',
    'nav.studentVerifications': '学生申请审核',
    'nav.merchants': '商户管理',
    'nav.merchantCategories': '商户类型',
    'nav.adSlots': '广告栏管理',
    'nav.adContents': '广告内容管理',
    'nav.videos': '视频管理',
  ...
  ja: {
    ...
    'nav.tasks': 'タスク',
    'nav.studentVerifications': '学生申請審査',
    'nav.merchants': '店舗管理',
    'nav.merchantCategories': '店舗タイプ',
    'nav.adSlots': '広告欄管理',
    'nav.adContents': '広告コンテンツ管理',
    'nav.videos': '動画管理',
...
export const userTranslations: Translations = {
  zh: {
    ...
    // 学生免费申请
    'student.apply.title': '学生免费 AI 激活申请',
    'student.apply.subtitle': '请填写以下信息以提交在校学生申请',
    'student.apply.loading': '加载中...',
    'student.apply.loadFailed': '加载失败',
    'student.apply.submitFailed': '提交失败',
    'student.apply.submitSuccess': '申请已提交，正在审核',
    'student.apply.fullName': '姓名',
    'student.apply.nationality': '国籍',
    'student.apply.schoolName': '学校名称',
    'student.apply.email': '邮箱',
    'student.apply.phoneNumber': '手机号码',
    'student.apply.channelSource': '渠道方式（如何知道本服务）',
    'student.apply.studyFrom': '学习周期开始',
    'student.apply.studyTo': '学习周期结束',
    'student.apply.admissionDocs': '入学/在校证明（至少1份）',
    'student.apply.addFile': '添加文件',
    'student.apply.noFile': '暂无文件，至少添加一条',
    'student.apply.fileIdPlaceholder': '文件 ID',
    'student.apply.fileNamePlaceholder': '文件名',
    'student.apply.fileUrlPlaceholder': '文件链接（可选）',
    'student.apply.delete': '删除',
    'student.apply.uploading': '文件上传中...',
    'student.apply.uploadFailed': '文件上传失败',
    'student.apply.fileTooLarge': '文件大小不能超过 {size}',
    'student.apply.sizeLimit': '单文件大小上限：{size}',
    'student.apply.submitting': '提交中...',
    'student.apply.submit': '提交申请',
    'student.apply.viewStatus': '查看状态',
    'student.apply.docRequired': '请至少上传一份入学/在校证明',
    'student.status.title': '学生免费 AI 激活 - 状态',
    'student.status.loading': '加载中...',
    'student.status.loadFailed': '加载失败',
    'student.status.none': '尚未提交学生免费 AI 激活申请。',
    'student.status.applyNow': '去申请',
    'student.status.pending': '申请已提交，正在审核中。',
    'student.status.fullName': '姓名：{value}',
    'student.status.schoolName': '学校：{value}',
    'student.status.studyPeriod': '学习周期：{from} ~ {to}',
    'student.status.approved': '已通过审核',
    'student.status.validPeriod': '权益有效期：{from} ~ {to}',
    'student.status.rejected': '未通过审核',
    'student.status.reason': '原因：{value}',
    'student.status.resubmit': '修改信息后重新提交',
    'student.status.expired': '权益已过期',
    'student.status.reapply': '重新提交申请',
  ...
  en: {
    ...
    // Student free application
    'student.apply.title': 'Student Free AI Activation Application',
    'student.apply.subtitle': 'Please fill in the information below to submit your student application',
    'student.apply.loading': 'Loading...',
    'student.apply.loadFailed': 'Failed to load',
    'student.apply.submitFailed': 'Submission failed',
    'student.apply.submitSuccess': 'Application submitted, under review',
    'student.apply.fullName': 'Full Name',
    'student.apply.nationality': 'Nationality',
    'student.apply.schoolName': 'School Name',
    'student.apply.email': 'Email',
    'student.apply.phoneNumber': 'Phone Number',
    'student.apply.channelSource': 'How did you hear about us?',
    'student.apply.studyFrom': 'Study Period Start',
    'student.apply.studyTo': 'Study Period End',
    'student.apply.admissionDocs': 'Admission / Enrollment Proof (at least 1)',
    'student.apply.addFile': 'Add File',
    'student.apply.noFile': 'No files yet, please add at least one',
    'student.apply.fileIdPlaceholder': 'File ID',
    'student.apply.fileNamePlaceholder': 'File Name',
    'student.apply.fileUrlPlaceholder': 'File URL (optional)',
    'student.apply.delete': 'Delete',
    'student.apply.uploading': 'Uploading...',
    'student.apply.uploadFailed': 'Upload failed',
    'student.apply.fileTooLarge': 'File size cannot exceed {size}',
    'student.apply.sizeLimit': 'Max single file size: {size}',
    'student.apply.submitting': 'Submitting...',
    'student.apply.submit': 'Submit Application',
    'student.apply.viewStatus': 'View Status',
    'student.apply.docRequired': 'Please upload at least one admission/enrollment proof',
    'student.status.title': 'Student Free AI Activation - Status',
    'student.status.loading': 'Loading...',
    'student.status.loadFailed': 'Failed to load',
    'student.status.none': 'You have not submitted a student free AI activation application yet.',
    'student.status.applyNow': 'Apply now',
    'student.status.pending': 'Application submitted, under review.',
    'student.status.fullName': 'Name: {value}',
    'student.status.schoolName': 'School: {value}',
    'student.status.studyPeriod': 'Study Period: {from} ~ {to}',
    'student.status.approved': 'Approved',
    'student.status.validPeriod': 'Validity: {from} ~ {to}',
    'student.status.rejected': 'Rejected',
    'student.status.reason': 'Reason: {value}',
    'student.status.resubmit': 'Update info and resubmit',
    'student.status.expired': 'Benefits expired',
    'student.status.reapply': 'Reapply',
  ...
  ja: {
    ...
    // 学生無料申請
    'student.apply.title': '学生無料 AI アクティベーション申請',
    'student.apply.subtitle': '以下の情報を入力して在校生申請を送信してください',
    'student.apply.loading': '読み込み中...',
    'student.apply.loadFailed': '読み込みに失敗しました',
    'student.apply.submitFailed': '送信に失敗しました',
    'student.apply.submitSuccess': '申請を送信しました。審査中です',
    'student.apply.fullName': '氏名',
    'student.apply.nationality': '国籍',
    'student.apply.schoolName': '学校名',
    'student.apply.email': 'メールアドレス',
    'student.apply.phoneNumber': '電話番号',
    'student.apply.channelSource': 'どこで本サービスを知りましたか',
    'student.apply.studyFrom': '学習期間開始',
    'student.apply.studyTo': '学習期間終了',
    'student.apply.admissionDocs': '入学/在学証明（最低1件）',
    'student.apply.addFile': 'ファイルを追加',
    'student.apply.noFile': 'ファイルがありません。少なくとも1件追加してください',
    'student.apply.fileIdPlaceholder': 'ファイルID',
    'student.apply.fileNamePlaceholder': 'ファイル名',
    'student.apply.fileUrlPlaceholder': 'ファイルURL（任意）',
    'student.apply.delete': '削除',
    'student.apply.uploading': 'アップロード中...',
    'student.apply.uploadFailed': 'アップロードに失敗しました',
    'student.apply.fileTooLarge': 'ファイルサイズは {size} を超えないでください',
    'student.apply.sizeLimit': '単一ファイル上限：{size}',
    'student.apply.submitting': '送信中...',
    'student.apply.submit': '申請を送信',
    'student.apply.viewStatus': 'ステータスを確認',
    'student.apply.docRequired': '入学/在学証明を少なくとも1件アップロードしてください',
    'student.status.title': '学生無料 AI アクティベーション - ステータス',
    'student.status.loading': '読み込み中...',
    'student.status.loadFailed': '読み込みに失敗しました',
    'student.status.none': 'まだ学生無料 AI アクティベーションを申請していません。',
    'student.status.applyNow': '今すぐ申請',
    'student.status.pending': '申請済み、審査中です。',
    'student.status.fullName': '氏名：{value}',
    'student.status.schoolName': '学校：{value}',
    'student.status.studyPeriod': '学習期間：{from} ~ {to}',
    'student.status.approved': '承認済み',
    'student.status.validPeriod': '有効期間：{from} ~ {to}',
    'student.status.rejected': '審査に通過しませんでした',
    'student.status.reason': '理由：{value}',
    'student.status.resubmit': '情報を更新して再申請',
    'student.status.expired': '特典の有効期限が切れました',
    'student.status.reapply': '再申請する',
