请汇总问题，并参照/Users/leo/Desktop/drivequiz研发规范/✅ 《Cursor 问题诊断信息模板 v1.0》.md和/Users/leo/Desktop/drivequiz研发规范/📝 Cursor 执行报告通用模板 v1.0.md，输出问题诊断报告到docs/问题修复/（修复当天年份日期）/(请自行建立针对性问题命名文件夹)，并且在该文件夹内建立相应的“诊断报告”“解决指令”“执行报告”三个文件夹，只需要撰写问题诊断报告，报告内需要涵盖问题的整体叙述、日志信息，以及之前采取过的措施详情，不用写解决指令和执行报告，也不用做任何执行修复。
